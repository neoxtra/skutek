...
Processing data found across multiple files and performing analysis on them.
This example will be filled in upon the creation of a new app note, but for now, it exists as a skeleton for theoretical demonstration purposes.
"""
###############################################################################
# Skutils loaders can only open one file per "loader object", meaning that you
# need to "instantiate" a new loader for every file you open, here's an example
